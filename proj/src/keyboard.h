 ...
 * 
 * 
 *  Functions responsible for the keyboard functionality
 */
...
/**
 * @brief Enables keyboard interrupt notifications
 * 
...
/**
 * @brief Disables keyboard interrupt notifications
 * 
 * @return int Returns 0 if successful, 0 otherwise
 */
int keyboard_disable();

int clean_output_buffer();
